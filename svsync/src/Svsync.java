...
import svsync.engines.Analyzer;
import svsync.engines.Restorer;
import svsync.engines.Syncer;
...
public class Svsync {
    ...
    private static void printUsage() {
        System.out.println("USAGE: smartsync -profile <profile> [-analyze] [-restore <>]");
    }
